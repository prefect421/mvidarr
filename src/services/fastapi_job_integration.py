...
from .background_workers import get_worker_manager, BackgroundWorkerManager
...
async def initialize_fastapi_job_system(worker_count: int = 2) -> bool:
    ...
    try:
        ...
        logger.info(f"✅ FastAPI job system initialized successfully with {worker_count} workers")
        return True
