...
async def get_enhanced_scheduler_status(
    ...
    try:
        ...
        logger.info(f"Getting enhanced scheduler status for user {current_user.get('username')}")
...
async def start_enhanced_scheduler(
    ...
    try:
        ...
        logger.info(f"Starting enhanced scheduler for admin user {current_user.get('username')}")
...
async def stop_enhanced_scheduler(
    ...
    try:
        ...
        logger.info(f"Stopping enhanced scheduler for admin user {current_user.get('username')}")
        
        enhanced_scheduler_service.stop()
        
        return {
            "success": True,
            "message": "Enhanced scheduler stopped successfully"
        }
...
async def reload_enhanced_scheduler(
    ...
    try:
        ...
        logger.info(f"Reloading enhanced scheduler for admin user {current_user.get('username')}")
        
        enhanced_scheduler_service.reload_schedule()
        
        return {
            "success": True,
            "message": "Enhanced scheduler reloaded successfully"
        }
...
async def trigger_enhanced_download(
    ...
    try:
        ...
        logger.info(f"Triggering enhanced download task for user {current_user.get('username')}")
        
        result = enhanced_scheduler_service.trigger_download_now()
        
        if not result.get("success"):
            raise HTTPException(status_code=500, detail=result.get("message", "Failed to trigger download"))
...
async def trigger_enhanced_discovery(
    ...
    try:
        ...
        logger.info(f"Triggering enhanced discovery task for user {current_user.get('username')}")
        
        result = enhanced_scheduler_service.trigger_discovery_now()
        
        if not result.get("success"):
            raise HTTPException(status_code=500, detail=result.get("message", "Failed to trigger discovery"))
...
async def get_enhanced_scheduler_config(
    ...
    try:
        ...
        logger.info(f"Getting enhanced scheduler config for user {current_user.get('username')}")
...
async def get_enhanced_scheduler_logs(
    ...
    try:
        ...
        logger.info(f"Getting enhanced scheduler logs (limit={limit}, level={level}) for user {current_user.get('username')}")
