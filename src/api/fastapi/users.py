...
Note: PUT /{user_id}/role was removed — src/api/fastapi/admin.py already
implements correct, full 4-role (UserRole) user management and is what
/admin/users actually uses. This file's version wrote to a non-existent
is_admin column and silently never persisted (see #310).
"""
...
class CreateUserRequest(BaseModel):
    ...
    role: str = Field(default="USER", pattern="^(ADMIN|MANAGER|USER|READONLY)$")
